					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu" id="main-menu">
								...
								<li class="no_planner no_bulletin"><a><i class="fa fa-edit" ></i>待申请<span
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate
										class="form-horizontal form-label-left" action="addNotice" method="post">

										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="title">主题<span class="required">*</span>
											</label>
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12" >优先级
												<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<select class="form-control" name="priority">
						                            <option selected="selected" value="1" >选择优先级</option>
										...
										<span style="color: red; float: right"><c:if test="${msg!=null }">
